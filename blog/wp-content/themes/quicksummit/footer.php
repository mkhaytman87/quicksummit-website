        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                ...
                <div>
                    <div class="flex items-center mb-4">
                        <img src="/logo-white.svg" alt="QuickSummit Logo" class="h-8 w-auto" />
                        <span class="ml-2 text-xl font-bold">QuickSummit</span>
                    </div>
                    <p class="text-gray-400 mb-4">
                        Empowering businesses with intelligent automation solutions.
                    </p>
                    <div class="flex space-x-4">
                        <a href="https://twitter.com/quicksummit" class="text-gray-400 hover:text-white transition-colors duration-200"
                        ...
                        <a href="https://linkedin.com/company/quicksummit" class="text-gray-400 hover:text-white transition-colors duration-200"
                            target="_blank" rel="noopener noreferrer">
                        ...
                        <a href="https://github.com/quicksummit" class="text-gray-400 hover:text-white transition-colors duration-200"
                            target="_blank" rel="noopener noreferrer">
            ...
            <div class="border-t border-gray-800 pt-8">
                <p class="text-center text-gray-400">
                    © <?php echo date('Y'); ?> QuickSummit. All rights reserved.
                </p>
            </div>
        </div>
    </footer>
