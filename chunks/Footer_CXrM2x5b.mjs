...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const sharedHeader = await Astro2.glob(/* #__PURE__ */ Object.assign({"../../shared/header.html": () => import('./header_DWzt6fKn.mjs')}), () => "../../shared/header.html");
